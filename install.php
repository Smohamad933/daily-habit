...
if ($withDemo) {
    ...
    if (!$exists) {
        ...
        try {
            ...
            // عادت‌ها
            $habits = [['تمرین آواز خوانی', '#ef4767'], ['مطالعه برنامه‌نویسی', '#2f9df4'], ['ورزش و باشگاه', '#22c793']];
            $hids = [];
...
a{display:inline-block;background:#7c5cff;color:#fff;padding:11px 26px;border-radius:10px;text-decoration:none;margin:6px}
