...
<div class="grid cols-2" style="align-items:start">
  <div class="card">
    ...
    <div class="mt" style="display:flex;gap:8px;flex-wrap:wrap">
      <a class="btn sm" href="users.php">👥 مدیریت کاربران</a>
      <a class="btn sm success" href="export.php">📥 خروجی اکسل</a>
    </div>
  </div>
  ...
  <div>
    <div class="card">
      ...
      <div class="grid cols-2" style="gap:10px">
        <a class="btn ghost" href="users.php">👥 کاربران و جزئیات</a>
        <a class="btn ghost" href="content.php">📝 محتوای سایت</a>
        <a class="btn ghost" href="settings.php">⚙ تنظیمات</a>
        <a class="btn ghost" href="export.php">📥 خروجی اکسل</a>
      </div>
