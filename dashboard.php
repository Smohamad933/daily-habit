...
<div class="card pad-lg" style="display:flex;align-items:center;gap:18px;flex-wrap:wrap">
  ...
  <div style="width:100%">
    ...
    <?php endif; ?>
    <?php if ($day['percent'] == 100 && $day['total'] > 0): ?><span class="chip c-good">🏅 روز کامل!</span><?php endif; ?>
  </div>
</div>
...
<!-- عادت‌های امروز -->
<div class="card mt">
  <h2>🔁 عادت‌های امروز <a href="<?= url('habits.php') ?>" class="small" style="margin-inline-start:auto">مدیریت ←</a></h2>
  <?php if (!$habits): ?>
...
<?php if ($recentNotifs): ?>
<div class="card mt">
  <h2>🔔 آخرین اعلان‌ها <a href="<?= url('notifications.php') ?>" class="small" style="margin-inline-start:auto">همه ←</a></h2>
  <div class="item-list">
