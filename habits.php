...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && csrf_check()) {
    ...
    if ($act === 'add') {
        ...
        $color = preg_match('/^#[0-9a-fA-F]{6}$/', $_POST['color'] ?? '') ? $_POST['color'] : '#5b5bd6';
        if ($title !== '') {
...
<div class="page-head">
  <h1 style="margin:0">🔁 عادت‌های روزانه</h1>
</div>
...
<div class="card" style="margin-bottom:14px">
  ...
  <form method="post">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center">
      ...
      <input type="color" name="color" value="#5b5bd6" style="width:52px;height:44px;padding:4px;flex:none">
...
<div class="card" style="margin-bottom:12px">
  <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap">
    ...
    <form method="post" style="margin-inline-start:auto" onsubmit="return confirm('این عادت بایگانی شود؟')">
      ...
      <button class="icon-btn" title="بایگانی">🗄</button>
    </form>
  </div>
